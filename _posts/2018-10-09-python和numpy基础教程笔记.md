...
Python也有内置的长整型和复杂数字类型，具体细节可以查看[文档](https://docs.python.org/3.6/tutorial/introduction.html#numbers)。  
...
想要知道字典的其他特性，请查阅[文档](https://docs.python.org/3.6/tutorial/datastructures.html#dictionaries)。
